...
const ProductCard: React.FC<ProductCardProps> = ({
    ...
    const handleAddRating = async () => {
        ...
        if (newRating && newRating >= 1 && newRating <= 5) {
            if (product.id !== undefined) {
                await ProductService.addReviewToProduct(product.id, newRating);
            }
    ...
    return (
        ...
        >
            <article
                key={product.id}
                className="flex flex-row bg-gray-50  overflow-hidden "
                style={{ width: '100%' }}
            >
                {/* The layout changes on whether it's a grid or not */}
                {grid ? (
                    <>
                        <div className="flex flex-col justify-between items-center m-2">
                            ...
                            />
                            <div className="flex flex-col w-full mt-4 height-full">
                                <div className="">
                                        ...
                                        {quantity &&
                                            (product.stock - quantity <= 0 ? (
                                                ...
                                                product.stock - quantity < 5 && (
                                                    <p className="text-red-500 font-semibold">
                                                        Low stock: Only {product.stock - quantity}{' '}
                                                        left.
                                                    </p>
                                                )
                                            ))}
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center mt-2">
                                            ...
                                            <button
                                                ...
                                                className="bg-black text-white py-2 px-4 rounded h-10"
                                            >
                                                Submit Rating
                                            </button>
                                        </div>
                                        ...
                                        {addItemToCart &&
                                            ...
                                            loggedInUser.role === 'customer' && (
                                                <button
                                                    ...
                                                    className=" bg-black border p-3 rounded-lg transition duration-200 hover:bg-blue-700"
                                                >
                                                    <Image
                                        ...
                                        {wishlist &&
                                            ...
                                            !wishlist.some(
                                                (productInWishlist: Product) =>
                                                    productInWishlist.id === product.id
                                            ) && (
                                                <button
                                                    type="button"
                                                    onClick={(e) => {
                                                    ...
                                                    className="p-3 m-1 rounded-xl text-sm font-normal transition duration-200 hover:bg-gray-200"
                                                >
                                                    <svg
                                        ...
                                        {wishlist &&
                                            ...
                                            wishlist.some(
                                                ...
                                                <button
                                                    ...
                                                    className="p-3 m-1 rounded-xl text-sm font-normal transition duration-200 hover:bg-blue-200"
                                                >
                                                    <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        viewBox="0 0 512 512"
