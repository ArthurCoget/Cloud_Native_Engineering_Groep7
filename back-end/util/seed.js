...
const calculateTotalAmount = (items, prisma) => __awaiter(void 0, void 0, void 0, function* () {
    let totalAmount = 0;
...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield prisma.discountCode.deleteMany();
    ...
    const janeSmith = yield prisma.customer.create({
        data: {
            ...
            password: yield bcrypt_1.default.hash('password456', 12),
            role: 'customer',
            wishlist: {},
        },
    });
    const aliceJohnson = yield prisma.customer.create({
        data: {
            ...
            password: yield bcrypt_1.default.hash('password789', 12),
            role: 'customer',
            wishlist: {},
        },
    });
    const admin = yield prisma.customer.create({
        data: {
            firstName: 'Admin',
            lastName: 'User',
            email: 'admin@example.com',
            password: yield bcrypt_1.default.hash('admin123', 12),
            role: 'admin',
            wishlist: {},
        },
    });
    const salesman = yield prisma.customer.create({
        data: {
            firstName: 'Salesman',
            lastName: 'User',
            email: 'salesman@example.com',
            password: yield bcrypt_1.default.hash('salesman123', 12),
            role: 'salesman',
            wishlist: {},
        },
    });
    const tShirt = yield prisma.product.create({
        data: {
            name: 'Basic T-Shirt',
            price: 19.99,
            stock: 100,
    ...
    const runningShoes = yield prisma.product.create({
        data: {
            name: 'Running Shoes',
            price: 79.99,
            stock: 50,
    ...
    const casualHoodie = yield prisma.product.create({
        data: {
            name: 'Casual Hoodie',
            price: 39.99,
            stock: 75,
    ...
    const classicWatch = yield prisma.product.create({
        data: {
            name: 'Classic Watch',
            price: 99.99,
            stock: 30,
    ...
    const denimJeans = yield prisma.product.create({
        data: {
            name: 'Denim Jeans',
            price: 49.99,
            stock: 60,
    ...
    const three_D_glasses = yield prisma.product.create({
        data: {
    ...
    const coog_sunglasses = yield prisma.product.create({
        data: {
    ...
    const heart_shirt = yield prisma.product.create({
        data: {
    ...
    const pearl_necklace = yield prisma.product.create({
        data: {
            name: 'Pearl Necklace',
            price: 49.99,
            stock: 40,
    ...
    const sports_shoe = yield prisma.product.create({
        data: {
            name: 'Sports Shoe',
            price: 59.99,
            stock: 80,
    ...
    const classic_watch_mk_ii = yield prisma.product.create({
        data: {
    ...
    const stylish_bag = yield prisma.product.create({
        data: {
            name: 'Stylish Bag',
            price: 34.99,
            stock: 120,
    ...
    const summer_dress = yield prisma.product.create({
        data: {
            name: 'Summer Dress',
            price: 44.99,
            stock: 60,
    ...
    const polo_shirt = yield prisma.product.create({
        data: {
            name: 'Polo Shirt',
            price: 29.99,
            stock: 90,
    ...
    const silver_ring = yield prisma.product.create({
        data: {
            name: 'Silver Ring',
            price: 19.99,
            stock: 200,
    ...
    const cozy_sweater = yield prisma.product.create({
        data: {
            name: 'Cozy Sweater',
            price: 39.99,
            stock: 80,
    ...
    const classic_watch_mk_iii = yield prisma.product.create({
        data: {
    ...
    const warm_beanie = yield prisma.product.create({
        data: {
            name: 'Warm Beanie',
            price: 14.99,
            stock: 130,
    ...
    const leather_gloves = yield prisma.product.create({
        data: {
            name: 'Leather Gloves',
            price: 24.99,
            stock: 70,
    ...
    const santa_hat = yield prisma.product.create({
        data: {
            name: 'Santa Hat',
            price: 9.99,
            stock: 150,
    ...
    const skibidi_sunglasses = yield prisma.product.create({
        data: {
    ...
    const swimming_shorts = yield prisma.product.create({
        data: {
    ...
    const classic_watch_mk_iv = yield prisma.product.create({
        data: {
    ...
    const gift_bow = yield prisma.product.create({
        data: {
            name: 'Gift Bow',
            price: 4.99,
            stock: 300,
    ...
    const woolen_gloves_2_0 = yield prisma.product.create({
        data: {
    ...
    const kids_tshirt = yield prisma.product.create({
        data: {
            name: 'Kid’s T-Shirt',
            price: 14.99,
            stock: 90,
    ...
    const plain_shirt = yield prisma.product.create({
        data: {
            name: 'Plain Shirt',
            price: 24.99,
            stock: 110,
    ...
    const skinny_jeans = yield prisma.product.create({
        data: {
            name: 'Skinny Jeans',
            price: 49.99,
            stock: 70,
    ...
    const top_hat = yield prisma.product.create({
        data: {
            name: 'Top Hat',
            price: 39.99,
            stock: 40,
    ...
    const classic_watch_mk_v = yield prisma.product.create({
        data: {
    ...
    const baseball_cap = yield prisma.product.create({
        data: {
            name: 'Baseball Cap',
            price: 14.99,
            stock: 100,
    ...
    const classic_hat = yield prisma.product.create({
        data: {
            name: 'Classic Hat',
            price: 24.99,
            stock: 50,
    ...
    const kid_shoe = yield prisma.product.create({
        data: {
            name: 'Kid’s Shoe',
            price: 29.99,
            stock: 80,
    ...
    const shirt_variant_3 = yield prisma.product.create({
        data: {
    ...
    const summer_skirt = yield prisma.product.create({
        data: {
            name: 'Summer Skirt',
            price: 34.99,
            stock: 60,
    ...
    const ugly_christmas_sweater = yield prisma.product.create({
        data: {
    ...
    const classic_shoe = yield prisma.product.create({
        data: {
            name: 'Classic Shoe',
            price: 59.99,
            stock: 80,
    ...
    const hat_variant_2 = yield prisma.product.create({
        data: {
            name: 'Hat Variant 2',
            price: 24.99,
            stock: 50,
    ...
    const work_shoe = yield prisma.product.create({
        data: {
            name: 'Work Shoe',
            price: 69.99,
            stock: 60,
    ...
    const tenPercentOff = yield prisma.discountCode.create({
        data: {
            code: 'SAVE10P',
            type: 'percentage',
            value: 10,
    ...
    const twentyPercentOff = yield prisma.discountCode.create({
        data: {
            code: 'SAVE20P',
            type: 'percentage',
            value: 20,
    ...
    const inactivePercentOff = yield prisma.discountCode.create({
        data: {
            code: 'INACTIVEP',
            type: 'percentage',
            value: 20,
    ...
    const thirtyFixedOff = yield prisma.discountCode.create({
        data: {
            code: 'SAVE30F',
            type: 'fixed',
            value: 30,
    ...
    const fiftyFixedOff = yield prisma.discountCode.create({
        data: {
            code: 'SAVE50F',
            type: 'fixed',
            value: 50,
    ...
    const inactiveFixedOff = yield prisma.discountCode.create({
        data: {
            code: 'INACTIVEF',
            type: 'fixed',
            value: 50,
    ...
    const cartJohn = yield prisma.cart.create({
        data: {
            customer: {
    ...
    const cartJaneSmith = yield prisma.cart.create({
        data: {
            customer: {
    ...
    const cartAliceJohnson = yield prisma.cart.create({
        data: {
            customer: {
    ...
    const cartAdmin = yield prisma.cart.create({
        data: {
            customer: {
                connect: { id: admin.id },
            },
    ...
    const cartSalesman = yield prisma.cart.create({
        data: {
            customer: {
    ...
    const johnTotalAmount = yield calculateTotalAmount(johnOrderItems, prisma);
    const orderJohn = yield prisma.order.create({
        data: {
            customer: {
                connect: { id: johnDoe.id },
            },
    ...
    const aliceTotalAmount = yield calculateTotalAmount(aliceOrderItems, prisma);
    const orderAlice = yield prisma.order.create({
        data: {
            customer: {
                connect: { id: aliceJohnson.id },
            },
