...
const getCartById = (_a) => __awaiter(void 0, [_a], void 0, function* ({ id }) {
    try {
...
const getCartByCustomerEmail = (_a) => __awaiter(void 0, [_a], void 0, function* ({ email }) {
    try {
...
const getCartByCustomerId = (_a) => __awaiter(void 0, [_a], void 0, function* ({ id }) {
    try {
        const cartPrisma = yield database_1.default.cart.findUnique({
            where: { customerId: id },
            include: {
...
const deleteCart = (_a) => __awaiter(void 0, [_a], void 0, function* ({ id }) {
    try {
