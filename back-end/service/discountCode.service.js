...
const createDiscountCode = ({ code, type, value, expirationDate, isActive }, email, role) => __awaiter(void 0, void 0, void 0, function* () {
    if (role === 'salesman') {
...
const updateDiscountCode = (currentCode, { code, type, value, expirationDate, isActive }, email, role) => __awaiter(void 0, void 0, void 0, function* () {
    if (role === 'salesman') {
