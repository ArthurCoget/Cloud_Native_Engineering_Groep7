...
const createCustomer = (_a) => __awaiter(void 0, [_a], void 0, function* ({ firstName, lastName, email, password, }) {
...
const updateCustomer = (currentEmail_1, _a, authEmail_1, role_1) => __awaiter(void 0, [currentEmail_1, _a, authEmail_1, role_1], void 0, function* (currentEmail, { firstName, lastName, email, password }, authEmail, role) {
    if (role === 'admin' ||
        role === 'salesman' ||
...
const authenticate = (_a) => __awaiter(void 0, [_a], void 0, function* ({ email, password, }) {
    const customer = yield customer_db_1.default.getCustomerByEmail({ email });
    if (!customer) {
