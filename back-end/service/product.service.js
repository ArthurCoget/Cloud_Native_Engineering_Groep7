...
const createProduct = (_a, email_1, role_1) => __awaiter(void 0, [_a, email_1, role_1], void 0, function* ({ name, price, stock, categories, description, images, sizes, colors, rating }, email, role) {
    if (role === 'admin') {
...
const addRatingToProduct = (productId, rating) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatedProduct = yield product_db_1.default.addRatingToProduct(productId, rating);
    if (!updatedProduct)
        throw new Error('Failed to add rating to product.');
