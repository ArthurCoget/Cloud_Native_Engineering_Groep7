...
const getDiscountCodeById = (_a) => __awaiter(void 0, [_a], void 0, function* ({ id }) {
    try {
...
const getDiscountCodeByCode = (_a) => __awaiter(void 0, [_a], void 0, function* ({ code }) {
    try {
        const discountCodePrisma = yield database_1.default.discountCode.findUnique({
            where: { code: code },
        });
...
const deleteDiscountCode = (_a) => __awaiter(void 0, [_a], void 0, function* ({ code }) {
    try {
